...
function Message(msg) {
    ...
    this.collapse_key = this.collapse_key || undefined;
    this.delay_while_idle = this.delay_while_idle || undefined;
    this.time_to_live = this.time_to_live || undefined;
    this.dry_run = this.dry_run || undefined;
}
